package com.shelterTelegramBot.demo.utils;

public class ButtonsNames {
    public static String INFO_ABOUT_SHELTER_BUTTON_NAME = "Информация о приюте";
    public static String GET_PET_FROM_SHELTER_BUTTON_NAME = "Взять животное";
    public static String SEND_REPORT_PETS_BUTTON_NAME = "Отчет о питомце";
    public static String CALL_VOLUNTEER_BUTTON_NAME = "Позвать волонтера";
    public static String SCHEDULE_BUTTON_NAME = "График работы";
    ...
    public static String SHELTER_GROUP_INFO_ABOUT_SHELTER_BUTTON_DATA = "SHELTER_GROUP_INFO_ABOUT_SHELTER_BUTTON";
    public static String SHELTER_GROUP_SCHEDULE_BUTTON_DATA = "SHELTER_GROUP_INFO_SCHEDULE_BUTTON_DATA";
    public static String SHELTER_GROUP_DRIVING_DIRECTIONS_BUTTON_DATA = "SHELTER_GROUP_INFO_DRIVING_DIRECTIONS_BUTTON_DATA";
    public static String SHELTER_GROUP_GUARD_DETAILS_BUTTON_DATA = "SHELTER_GROUP_INFO_GUARD_DETAILS_BUTTON_DATA";
    public static String SHELTER_GROUP_SAFETY_PRECAUTIONS_BUTTON_DATA = "SHELTER_GROUP_INFO_SAFETY_PRECAUTIONS_BUTTON_DATA"; public static String GET_PET_FROM_SHELTER_BUTTON_DATA = "GET_PET_FROM_SHELTER_BUTTON";
...
//    public static String CHOOSES_SHELTER_BUTTON_DATA = "CHOOSES_SHELTER_BUTTON";
    ...
    public static String PET_NAME_BUTTON_DATA = "PET_GROUP_PET_INFO_NAME_BUTTON_DATA";
    public static String PET_AGE_BUTTON_DATA = "PET_GROUP_PET_INFO_AGE_BUTTON_DATA";
    public static String PET_BREED_BUTTON_DATA = "PET_GROUP_PET_INFO_BREED_BUTTON_DATA";
    public static String PET_COMMENT_BUTTON_DATA = "PET_GROUP_PET_INFO_COMMENT_BUTTON_DATA";
